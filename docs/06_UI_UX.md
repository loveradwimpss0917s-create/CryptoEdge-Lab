...
| SCR-04 | **Discovery Lab** | findings レビュー、候補生成の設定、文献インポート | discovery_findings, feature_defs |
...
```
┌ [Findings Inbox] [Screen Config] [Import from Literature]            ┐
...
│ │ 🤖 AI 接地案: forced_flow —「清算直後の OI 再構築は…」│             │
│ └───────────────────────────────────────────────────────┘             │
