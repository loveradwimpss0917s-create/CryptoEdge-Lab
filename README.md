...
**現在の状態**: 設計フェーズ完了。`docs/` 配下の設計書群が実装の一次入力である。
...
| 12 | [Operations](docs/12_OPERATIONS.md) | 保守・運用・バックアップ |

## 実装者向けの読み順

1. `00` を通読 (特に §3 設計原則 — 迷ったらここに従う)
2. `09` で V1 スコープと Phase を確認
3. Phase 0–1: `01` + `02` + `03` / Phase 2: `05` + `04` / Phase 3: `06` + `07` + `08`
4. 常時: `11` のテスト規約に従う
